 ...
 * Created by LuoLin on 2017/9/30.
 **/
public class LauncherUtils {
     ...
     * 添加当前应用的桌面快捷方式
     */
    public static void addShortcut(@NonNull Context context, @NonNull Class<? extends Activity> clazz,
            @NonNull Bundle bundle, @NonNull String title, int appIcon) {
    ...
    public static boolean hasShortcut(@NonNull Context context, @NonNull String title) {
        ...
        final Cursor c = context.getContentResolver().query(uri, null, "title=?", new String[]{title}, null);
