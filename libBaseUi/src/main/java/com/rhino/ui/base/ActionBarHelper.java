...
public class ActionBarHelper {
    ...
    /**
     * The left back key ImageView of title.
     */
    ...
    /**
     * Set the title back key color.
     *
     * @param color color
     */
    public void setTitleBackKeyColor(int color) {
        mTitleBackImageView.setColorStateList(DrawableUtils.buildColorStateList(ColorUtils.alphaColor(0.5f, color), color, ColorUtils.alphaColor(0.5f, color), color));
    }
    ...
    public void setTitleBackKeyColor(ColorStateList colorStateList) {
        mTitleBackImageView.setColorStateList(colorStateList);
    }
