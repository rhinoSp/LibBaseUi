...
public class RotateViewGroup extends ViewGroup {
    ...
    public RotateViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);

        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RotateViewGroup);
        angle = a.getInt(R.styleable.RotateViewGroup_rvg_angle, 0);
        a.recycle();
